    ...
    <>
      <div className="ps-0">
        ...
        <Section background="left-card">
          <Center>
            <Header>Unda interfaces za mtumiaji kutoka kwa vipengele</Header>
            <Para>
              ...
              vyako mwenyewe vya React kama <Code>Thumbnail</Code>,{' '}
              <Code>LikeButton</Code>, na <Code>Video</Code>. Kisha viunganishe
          ...
          <Center>
            <Para>
              Iwe unafanya kazi peke yako au na maelfu ya wasanidi programu
              wengine, kutumia React kunahisiwa vile vile. Imeundwa ili
              kukuruhusu kuunganisha bila matatizo vipengele vilivyoandikwa na
              watu, timu, na mashirika.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            <Header>Andika vipengele kwa kodi na alama (markup)</Header>
            <Para>
              Vipengele vya React ni vitendaji vya JavaScript. Unataka kuonyesha
              maudhui kwa masharti? Tumia kauli ya <Code>if</Code>. Kuonyesha
              orodha? Jaribu array <Code>map()</Code>. Kujifunza React ni
          ...
          <Center>
            <Para>
              Sintaksia hii ya alama inaitwa JSX. Ni upanuzi wa sintaksia ya
              JavaScript uliopata umaarufu kupitia React. Kuweka alama za JSX
              karibu na lojiki husika ya uwasilishaji (rendering logic) hufanya
              vipengele vya React kuwa rahisi kuunda, kudumisha, na kufuta.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="left-card">
          <Center>
            <Header>Ongeza mwingiliano popote unapouhitaji</Header>
            <Para>
              Vipengele vya React hupokea data na kurudisha kile kinachopaswa
              kuonekana kwenye kioo. Unaweza kuvipatia data mpya kama mwitikio
              wa mwingiliano, kama vile mtumiaji anapoandika kwenye kisanduku
              cha kuingiza data (input). Kisha React itahuisha kioo ili kiendane
              na data hiyo mpya.
            </Para>
          </Center>
          <FullBleed>
          ...
          <Center>
            <Para>
              Sio lazima ujenge ukurasa wako wote kwa React. Ongeza React kwenye
              ukurasa wako wa HTML uliopo, na uwasilishe (render) vipengele
              unganishi vya React popote pale.
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
                ...
                Ongeza React kwenye ukurasa wako
              </CTA>
            </div>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            <Header>
              Tumia full-stack <br className="hidden lg:inline" />
              pamoja na framework
            </Header>
            <Para>
              React ni maktaba. Inakuruhusu kuunganisha vipengele, lakini
              haielekezi jinsi ya kufanya uelekezaji (routing) na upataji wa
              data. Ili kujenga programu kamili na React, tunapendekeza
              framework ya full-stack kama{' '}
              <Link href="https://nextjs.org">Next.js</Link> au{' '}
          ...
          <Center>
            <Para>
              React pia ni usanifu (architecture). Frameworks zinazoitumia
              zinakuruhusu kupata data katika vipengele asilia (asynchronous
              components) vinavyofanya kazi kwenye seva au hata wakati wa ujenzi
              (build). Soma data kutoka kwenye faili au kanzi data (database),
              na ipitishe kwenye vipengele vyako unganishi.
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
                color="gray"
        ...
        <Section background="left-card">
          <div className="mx-auto flex flex-col w-full">
            <div className="mx-auto max-w-4xl lg:text-center items-center px-5 flex flex-col">
              <Header>Tumia ubora wa kila jukwaa</Header>
              <Para>
                Watu wanapenda programu za wavuti (web apps) na zile asilia
                (native apps) kwa sababu tofauti. React inakuruhusu kujenga zote
                mbili kwa kutumia ujuzi ule ule. Inategemea uimara wa kipekee wa
                kila jukwaa ili kufanya violesura vyako vionekane na kuhisiwa
                vyema kwenye kila jukwaa.
              </Para>
            </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative flex items-start justify-center flex-col flex-1 pb-16 pt-5 gap-3 px-5 lg:px-10 lg:pt-8">
                      ...
                      <p className="lg:text-xl leading-normal text-secondary">
                        Watu wanatarajia kurasa za programu za wavuti kupakia
                        haraka. Kwenye seva, React inakuruhusu kuanza
                        kutiririsha (streaming) HTML ukiwa bado unapata data, na
                        kujaza maudhui yaliyosalia hatua kwa hatua kabla ya kodi
                        yoyote ya JavaScript kupakiwa. Kwa upande wa mtumiaji
                        (client), React inaweza kutumia API za kawaida za wavuti
                        ili kufanya kiolesura chako (UI) kiendelee kuitikia kwa
                        haraka hata katikati ya uwasilishaji (rendering).
                      </p>
                    </div>
                  </div>
                </BrowserChrome>
                    ...
                    <div className="bg-gradient-right dark:bg-gradient-right-dark px-3 sm:px-3 pb-12 lg:pb-20 rounded-lg overflow-hidden">
                      ...
                      <div className="flex flex-col items-start justify-center pt-0 gap-3 px-2.5 lg:pt-8 lg:px-8">
                        ...
                        <p className="h-full lg:text-xl text-secondary dark:text-secondary-dark leading-normal">
                          Watu wanatarajia programu asilia (native apps)
                          zionekane na kuhisiwa kulingana na jukwaa lao.{' '}
                          <Link href="https://reactnative.dev">
                            React Native
                          </Link>{' '}
                          na{' '}
                          <Link href="https://github.com/expo/expo">Expo</Link>{' '}
                          zinakuruhusu kujenga programu kwa kutumia React kwa
                          ajili ya Android, iOS, na mifumo mingineyo.
                          Zinaonekana na kuhisiwa kama asilia kwa sababu
                          violesura vyake <i>ni</i> asilia kikweli. Sio
                          mwonekano wa wavuti—vipengele vyako vya React
                          vinawasilisha mionekano halisi ya Android na iOS
                          inayotolewa na jukwaa husika.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="px-5 lg:px-0 max-w-4xl mx-auto lg:text-center text-secondary dark:text-secondary-dark">
              <Para>
                Ukiwa na React, unaweza kuwa msanidi wa wavuti <i>na</i> wa
                mifumo asilia. Timu yako inaweza kutoa programu kwenye majukwaa
                mengi bila kuathiri hali ya utumiaji (user experience). Shirika
                lako linaweza kuunganisha migawanyiko ya majukwaa, na kuunda
                timu zinazosimamia vipengele vizima mwanzo hadi mwisho.
              </Para>
              <div className="flex justify-start w-full lg:justify-center">
                <CTA color="gray" icon="native" href="https://reactnative.dev/">
                  Jenga kwa ajili ya majukwaa asilia
                </CTA>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row px-5">
            <div className="max-w-3xl lg:max-w-7xl gap-5 flex flex-col lg:flex-row lg:px-5">
              <div className="w-full lg:w-6/12 max-w-3xl flex flex-col items-start justify-start lg:ps-5 lg:pe-10">
                <Header>Boresha wakati ujao ukiwa tayari</Header>
                <Para>
                  React hupokea mabadiliko kwa umakini mkubwa. Kila mabadiliko
                  ya kodi (commit) ya React hufanyiwa majaribio kwenye mifumo
                  muhimu ya kibiashara inayotumiwa na zaidi ya watumiaji bilioni
                  moja. Zaidi ya vipengele 100,000 vya React ndani ya Meta
                  husaidia kuhakiki kila mkakati wa uhamiaji.
                </Para>
                <div className="order-last pt-5">
                  <Para>
                    Timu ya React hufanya utafiti kila wakati kuhusu jinsi ya
                    kuiboresha React. Baadhi ya tafiti huchukua miaka mingi
                    kuleta matokeo. React ina vigezo vya juu sana kabla ya
                    kuingiza wazo la utafiti kwenye mazingira halisi ya matumizi
                    (production). Ni mbinu zilizothibitishwa pekee ndizo
                    zinazokuwa sehemu ya React.
                  </Para>
                  <div className="hidden lg:flex justify-start w-full">
                    <CTA color="gray" icon="news" href="/blog">
                      Soma habari zaidi za React
                    </CTA>
                  </div>
                </div>
              </div>
        ...
        <Section background="left-card">
          <div className="w-full">
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Header>
                  Jiunge na jumuiya <br className="hidden lg:inline" />
                  ya mamilioni
                </Header>
                <Para>
                  Hauko peke yako. Wasanidi programu milioni mbili kutoka kote
                  ulimwenguni hutembelea nyaraka (docs) za React kila mwezi.
                  React ni jambo ambalo watu na timu wanaweza kukubaliana
                  kuhusu.
                </Para>
              </Center>
            </div>
            ...
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Para>
                  Hii ndiyo sababu React ni zaidi ya maktaba, usanifu, au hata
                  mfumo wa ikolojia (ecosystem). React ni jumuiya. Ni mahali
                  ambapo unaweza kuomba msaada, kupata fursa, na kukutana na
                  marafiki wapya. Utakutana na watengenezaji programu na
                  wabunifu, wanaoanza na wataalamu, watafiti na wasanii, walimu
                  na wanafunzi. Asili zetu zinaweza kuwa tofauti sana, lakini
                  React inaturuhusu sote kuunda violesura vya watumiaji kwa
                  pamoja.
                </Para>
              </Center>
            </div>
          ...
          <div className="mt-20 px-5 lg:px-0 mb-6 max-w-4xl text-center text-opacity-80">
            ...
            <Header>
              Karibu kwenye <br className="hidden lg:inline" />
              jumuiya ya React
            </Header>
            <ButtonLink
              href={'/learn'}
